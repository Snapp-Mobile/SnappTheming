...
public final class SAThemingFontManager {
    ...
    public func registerFonts(_ fonts: [SAThemingFontInformation]) {
    ...
    public func unregisterFonts(_ fonts: [SAThemingFontInformation]) {
    ...
    public func registerFont(_ font: SAThemingFontInformation) {
        let availableFontPostScriptNames = getRegisteredFontsPostScriptNames()
    ...
    private func performFontRegistration(_ font: SAThemingFontInformation, at fontsDirectoryURL: URL?) {
        do {
    ...
    private func performFontUnregistration(_ font: SAThemingFontInformation, at fontsDirectoryURL: URL?) {
        do {
            let fontFileURL = try fileManager.fontFileURL(font, at: fontsDirectoryURL)
            if fileManager.fileExists(atPath: fontFileURL.path()) {
...
@discardableResult
fileprivate func registerFontsForURL(_ fontURL: URL, scope: SAThemingFontManager.Scope) throws -> Bool {
...
@discardableResult
fileprivate func unregisterFontsForURL(_ fontURL: URL, scope: SAThemingFontManager.Scope) throws -> Bool {
