...
public final class SAThemingImagesManager {
    ...
    func object(for key: String, of dataURI: SAThemingDataURI) -> UIImage? {
        do {
    ...
    func store(_ dataURI: SAThemingDataURI, for key: String) {
    ...
    private func imageCacheURL(for key: String, of dataURI: SAThemingDataURI) -> URL? {
