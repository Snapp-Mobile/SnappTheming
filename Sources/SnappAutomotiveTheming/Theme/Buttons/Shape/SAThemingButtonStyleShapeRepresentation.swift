//
//  SAThemingButtonStyleShapeRepresentation.swift
...
public struct SAThemingButtonStyleShapeRepresentation: Codable {
    let buttonStyleShape: SAThemingButtonStyleType
...
private enum ButtonStyleShapeType: String, Codable {
    ...
    init(_ rawValue: SAThemingButtonStyleType) {
        switch rawValue {
