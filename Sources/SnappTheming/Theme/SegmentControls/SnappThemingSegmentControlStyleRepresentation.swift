...
public struct SnappThemingSegmentControlStyleRepresentation: Codable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.selectedButtonStyle = try container.decode(
            SnappThemingToken<SnappThemingButtonStyleRepresentation>.self, forKey: .selectedButtonStyle)
        self.normalButtonStyle = try container.decode(
            SnappThemingToken<SnappThemingButtonStyleRepresentation>.self, forKey: .normalButtonStyle)
