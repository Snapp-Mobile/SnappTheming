...
enum SnappThemingShapeTypeRepresentation: Codable {
    case circle, rectangle, ellipse
    case capsule(StyleValue)
    ...
    init(from decoder: any Decoder) throws {
        ...
        case "capsule":
            self = .capsule(try StyleValue(from: decoder))
        ...
        case "unevenRoundedRectangle":
            self = .unevenRoundedRectangle(try UnevenRoundedRectangleValue(from: decoder))
